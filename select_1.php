...
<header>
  <nav class="navbar navbar-default">
    <div class="container-fluid">
      ...
      <a class="navbar-brand-login" href="login.php" onclick="alert('Bye!')">Logout</a>
      <input id="night_day" class="night" type="button" value="NIGHT"  onclick="alert('Do you want a change?')">
      </div>
    </div>
  </nav>
</header>
...
<!-- Main[Start] $view-->
<div>
    <div id="result" class="result"><?=$view?></div>
</div>

<!-- Main[End] -->
<script src="https://code.jquery.com/jquery-3.2.1.min.js"></script> 
    <!--jquery cdn 꼭 파일 위에 써야함 head부분에 쓸 경우 로딩 시간이 길어져서 보통 body에 씀-->
<script src="mission.js"></script>  <!-- //html과 스크립트를 연결// -->
